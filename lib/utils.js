...
const getTag = (fac) => {
  return JOURNEY_TAG[Math.log10(fac)];
}
...
export { MONTH_MAP, YUGA_NAME_MAP, JOURNEY_MAP, JOURNEY_TAG, JOURNEY, GOLDEN_COLOR, SILVER_COLOR, BRONZE_COLOR, IRON_COLOR, GOLDEN_COLOR_SOLID, SILVER_COLOR_SOLID, BRONZE_COLOR_SOLID, IRON_COLOR_SOLID, KEY_LEFT, KEY_UP, KEY_RIGHT, KEY_DOWN, INC, ANCHOR, ANCHOR_CELL, TURNS, SEGMENTS, CENTER_X, CENTER_Y, SVG_BOX, RADIUS, R1, R2, YUGA_SCALE, YUGA_SCALE_COLOR, GOLDEN_ANCHOR, IRON_ANCHOR, getYugaSvgData, getTag, formatToString, getDate, getCellAge, getCellAgeFromAngle };